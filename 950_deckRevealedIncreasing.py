...
作者：zi-mo-10
链接：https://leetcode-cn.com/problems/two-sum/solution/dang-zhao-bu-dao-gui-lu-shi-chang-shi-yi-xia-dao-z/
来源：力扣（LeetCode）
...
class Solution(object):
    def deckRevealedIncreasing(self, deck):
        ...
        for i in range(len(deck) - 1, -1, -1):
            myqueue.append(deck[i])
            if i == 0:
                break
            myqueue.append(myqueue.pop(0))
